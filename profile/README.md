...
**Learn-Run Frontend**는 현대적인 웹 애플리케이션 개발을 위한 완전한 보일러플레이트입니다.

- **Turborepo**를 기반으로 한 모노레포 구조에 최신 기술 스택을 통합하여, 개발자들이 즉시 프로덕션 레벨의 프로젝트를 시작할 수 있도록 설계되었습니다.
- **Shadcn/ui**와 **Tailwind CSS v4**의 완벽한 조합으로 아름다운 UI를 빠르게 구축할 수 있습니다.
- **TypeScript**와 **ESLint**, **Prettier**를 통한 코드 품질 관리로 안정적인 개발 환경을 제공합니다.
- **모노레포 아키텍처**를 통해 여러 앱과 패키지를 효율적으로 관리할 수 있습니다.
- **즉시 사용 가능한 설정**으로 복잡한 초기 설정 없이 바로 개발을 시작할 수 있습니다.
